...
const VentasEmpleado = () => {
  ...
  // Datos de ejemplo para las ventas (expandidos)
  ...
  return (
    <div className="ventas-empleado-container">
      <div className="announcement-bar">
        {/* Contenido del banner de anuncios si se necesita */}
      </div>
            ...
            ventasFiltradas.map((venta) => (
              <div key={venta.id} className="venta-card">
                ...
                <div className="venta-info">
                  <h3>Venta #{venta.id} - {venta.producto}</h3>
                  ...
                  <div className="venta-detalle">
                    ...
                    <span>Método de pago: {venta.metodo}</span>
                  </div>
